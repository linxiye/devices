...
struct sx126x_board_dev{
    void (*llcc68_set_reset)(uint8_t value);
    void (*llcc68_set_nss)(uint8_t value);
    uint8_t (*llcc68_get_busy)(void);
    uint8_t (*llcc68_get_dio1)(void);
    uint8_t (*spiinout)(uint8_t value);

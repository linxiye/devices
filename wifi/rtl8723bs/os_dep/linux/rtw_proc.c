...
inline struct proc_dir_entry *rtw_proc_create_entry(const char *name, struct proc_dir_entry *parent,
	const struct rtw_proc_ops *proc_ops, void * data)
{
	struct proc_dir_entry *entry;
...
static const struct rtw_proc_ops rtw_drv_proc_seq_proc_ops = {
...
static const struct rtw_proc_ops rtw_drv_proc_sseq_proc_ops = {
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 6, 0))
	.proc_open = rtw_drv_proc_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
...
static const struct rtw_proc_ops rtw_adapter_proc_seq_proc_ops = {
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 6, 0))
...
static const struct rtw_proc_ops rtw_adapter_proc_sseq_proc_ops = {
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 6, 0))
	.proc_open = rtw_adapter_proc_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
...
static const struct rtw_proc_ops rtw_odm_proc_seq_proc_ops = {
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 6, 0))
...
static const struct rtw_proc_ops rtw_odm_proc_sseq_proc_ops = {
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 6, 0))
	.proc_open = rtw_odm_proc_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
...
static const struct rtw_proc_ops rtw_mcc_proc_seq_proc_ops = {
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 6, 0))
...
static const struct rtw_proc_ops rtw_mcc_proc_sseq_proc_ops = {
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(5, 6, 0))
	.proc_open = rtw_mcc_proc_open,
	.proc_read = seq_read,
	.proc_lseek = seq_lseek,
